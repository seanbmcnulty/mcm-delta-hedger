...
import { n as auth } from "./server-B4OakpBB.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-C8kQN2Gm.js
...
function Tooltip({ content, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Root3, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trigger, {
			...
			sideOffset: 6,
			className: cn("z-50 max-w-xs rounded-md bg-surface-2 px-2.5 py-1.5 text-xs text-fg shadow-[0_0_0_1px_rgba(255,255,255,0.10)]"),
			children: content
		}) })]
	});
}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QueryClientProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TooltipProvider, {
			...
			children: [children, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
				...
				toastOptions: { className: "bg-surface-2 text-fg border-border font-sans" }
			})]
		})
	});
}
var styles_default = "/assets/styles-JyXVuPuQ.css";
var APP_NAME = "MCM Delta Hedger";
var Route$4 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "MCM Delta Hedger — Deribit portfolio delta hedge for BTC and ETH."
			}
		],
		links: [
			{
...
var $$splitComponentImporter$1 = () => import("./routes-D3uimbt8.mjs");
var Route$3 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-C0VSHb9x.mjs");
...
async function run(request) {
	...
	const result = await (await import("./runtime.server-CwKahFLN.mjs")).cronSweep();
	return Response.json(result);
}
var Route = createFileRoute("/api/hedge/cron")({ server: { handlers: {
...
var rootRouteChildren = {
	...
	ApiHedgeCronRoute: Route.update({
		id: "/api/hedge/cron",
		path: "/api/hedge/cron",
		getParentRoute: () => Route$4
	})
...
//#endregion
export { Tooltip as n, cn as r, router_exports as t };
